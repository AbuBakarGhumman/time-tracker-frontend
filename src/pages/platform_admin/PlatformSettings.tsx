...
import { getStoredPlatformAdmin, logout } from "../../api/auth";
import { API_BASE_URL } from "../../api/config";
import CacheManager from "../../utils/cacheManager";
import type { PlatformAdmin } from "../../api/auth";
    ...
    <div className="min-h-screen bg-slate-50 p-1">
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-4">
            <div>
              ...
              <p className="text-sm text-white/90">
                Manage your platform admin preferences
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Third Column with AI Assistant and Security */}
